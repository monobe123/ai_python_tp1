# This code trains a model to predict students' final grades based on various factors and displays the predictions.
...
# Load the dataset
data = pd.read_csv('C:/Users/mohamed/Desktop/AI_python_TP/student-mat.csv', sep=';')
